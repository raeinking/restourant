    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
            ...
            <ul>
              <li><a href="/addProduct"><i class="material-icons-outlined">arrow_right</i>Add Product</a>
              </li>
              <li><a href="/products"><i class="material-icons-outlined">arrow_right</i>Products</a>
              </li>
